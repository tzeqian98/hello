...
public class HomeController {
    ...
    public ResponseEntity<StringResponse> healthcheck(){
        return ResponseEntity.status(HttpStatus.OK).body(new StringResponse("OK - healthy"));
    }
    ...
    public ResponseEntity<CountResponse> metrics(){
        return ResponseEntity.status(HttpStatus.OK).body(new CountResponse("success",0,100,20));
    }
